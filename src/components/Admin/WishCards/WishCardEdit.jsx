...
const WishCardEditMode = ({ editWish, toggleEditMode, handleChange, wish: { id, text, linkToPrisjakt, url }  }) => {
    return (
            <Paper elevation={6} className="WishCard">
                ...
                <section className="WishCard-Toolbar">
                    ...
                    <Button raised className="Form-margin" color="primary" onClick={() => editWish({ id, text, linkToPrisjakt, url })}>
                        Save
                    </Button>
                </section>
            </Paper>
